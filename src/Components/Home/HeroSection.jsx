    ...
    return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-white space-y-6 md:max-w-2xl">
          <h1 className="text-5xl font-bold animate__animated animate__fadeInDown" style={{ animationDelay: '500ms' }}>
            Protect Your Home with Quality Roofing
          </h1>
          <p className="text-lg animate__animated animate__fadeInUp" style={{ animationDelay: '1000ms' }}>
